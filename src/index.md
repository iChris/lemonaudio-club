---
layout: base
title: Learn to edit video & audio podcasts
eleventyNavigation:
  key: Home
seo:
...
<div class="max-w-5xl mx-auto">
  ...
  <!-- ===================== WHO IT'S FOR ===================== -->
  <section class="bg-gray-100 rounded px-6 py-10 sm:px-10 mb-8">
    <h2 class="text-3xl sm:text-4xl font-bold mb-6">Who this is for</h2>
    <div class="flex flex-wrap -mx-3">
      <div class="w-full sm:w-1/2 px-3 mb-4">
        <p class="text-lg leading-relaxed text-gray-800"><span class="text-green-600 font-bold">✓</span> <strong>Podcasters</strong> trying to add video to a show you already love making.</p>
      </div>
      <div class="w-full sm:w-1/2 px-3 mb-4">
  ...
  <!-- ===================== WHO IT'S NOT FOR ===================== -->
  <section class="bg-red-100 rounded px-6 py-10 sm:px-10 mb-16">
    <h2 class="text-3xl sm:text-4xl font-bold mb-6">Who this is <em>not</em> for</h2>
    <div class="flex flex-wrap -mx-3">
      <div class="w-full sm:w-1/2 px-3 mb-4">
      ...
      <div class="w-full sm:w-1/2 px-3 mb-4">
        <p class="text-lg leading-relaxed text-gray-800"><span class="text-red-600 font-bold">✕</span> Folks chasing a <strong>magic shortcut</strong> instead of what actually works.</p>
      </div>
    </div>
  </section>
